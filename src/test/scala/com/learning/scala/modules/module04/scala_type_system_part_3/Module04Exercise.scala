 ...
 */
class Module04Exercise extends FunSpec with Matchers with SeveredStackTraces {
    ...
    def sameLength(o1: { def length: Int }, o2: { def length: Int }): Boolean = {
        o1.length == o2.length
    }
    ...
    describe ("Using refinement types") {
        ...
        def phForFruit(fruit: Fruit { def ph: Int }): Int = {
            fruit.ph
        }
